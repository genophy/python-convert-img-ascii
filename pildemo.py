"""
the code for python3 , the original version is on [https://www.hackerearth.com/practice/notes/beautiful-python-a-simple-ascii-art-generator-from-images/]

just share and modify
"""
# -*- coding:utf-8 -*-
